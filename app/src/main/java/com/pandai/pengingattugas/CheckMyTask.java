...
public class CheckMyTask extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checkmytask);
    ...
    public void loadListView(NoScrollListView listView, final ArrayList<HashMap<String, String>> dataList) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(CheckMyTask.this, AddModifyTask.class);
